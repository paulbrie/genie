module.exports = [
"[project]/node_modules/subjecto/dist/react/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function T(n) {
    let r = ()=>n.getValue();
    return [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])((e)=>{
            let t = n.subscribe(e);
...
function f(n, r) {
    let u = r.split("/"), e = n.getValue();
    for (let t of u)if (e && typeof e == "object" && !Array.isArray(e) && t in e) e = e[t];
    else return;
    return e;
}
function R(n, r) {
    let u = ()=>f(n, r);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])((e)=>{
        let t = `${r}/**`, c = n.subscribe(t, e, {
...
function h(n, r, u) {
    let e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(void 0), t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(void 0), c = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(void 0), b = ()=>{
        let o = f(n, r);
        if (o !== e.current) {
            e.current = o;
            let s = u(o);
            if (typeof s == "object" && s !== null) {
                ...
                a !== c.current && (c.current = a, t.current = s);
            } else t.current = s;
        }
        return t.current;
    };
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])((o)=>{
        let s = `${r}/**`, a = n.subscribe(s, ()=>{
            let p = f(n, r), i = u(p);
            if (e.current = p, typeof i == "object" && i !== null) {
                let S = JSON.stringify(i);
                S !== c.current && (c.current = S, t.current = i, o());
            } else i !== t.current && (t.current = i, o());
        }, {
            skipInitialCall: true
        });
...
"[project]/node_modules/subjecto/dist/index.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var y = "noName", m = true, d = {
    ...
    constructor(s, t){
        var r, e;
        this.me = this, this.options = {
            name: (r = t == null ? void 0 : t.name) != null ? r : y,
            updateIfStrictlyEqual: (e = t == null ? void 0 : t.updateIfStrictlyEqual) != null ? e : true
        }, this.value = s, this.subscribers = new Map, this.debug = false, this.before = (i)=>i, this.count = 1;
    }
    nextAssign(s) {
        if (typeof this.value != "object") throw new Error(d.VALUE_NOT_OBJECT);
        this.next(Object.assign({}, this.value, s));
    }
    nextPush(s) {
        if (!Array.isArray(this.value)) throw new Error(d.VALUE_NOT_ARRAY);
        this.next([
            ...this.value,
            s
        ]);
    ...
    toggle() {
        typeof this.value == "boolean" && this.me.next(!this.value);
    }
    once(s) {
        let t = Symbol("subscriber-once");
        this.subscribers.set(t, (e)=>{
            s(e), this.unsubscribe(t);
        });
    ...
    complete() {
        Array.from(this.subscribers.keys()).forEach((s)=>{
            this.me.unsubscribe(s);
        });
    }
    next(s) {
        !this.options.updateIfStrictlyEqual && this.value === s || (this.value = this.before(s), this.count++, this.subscribers.forEach((t)=>{
            try {
                t(this.value);
            } catch (r) {}
        }), b);
...
function v(c, s) {
    ...
    else if (c.includes("**")) e = g(c, s);
    else {
        let i = c.split("/"), u = s.split("/");
        i.length !== u.length ? e = false : e = i.every((o, n)=>o === "*" || o === u[n]);
    }
    if (l.size >= x) {
...
function g(c, s) {
    let t = c.split("/"), r = s.split("/"), e = 0, i = 0;
    for(; e < t.length && i < r.length;)if (t[e] === "**") {
        if (e === t.length - 1) return true;
        for(; i < r.length;){
            if (g(t.slice(e + 1).join("/"), r.slice(i).join("/"))) return true;
            i++;
        }
        return false;
    } else if (t[e] === "*" || t[e] === r[i]) e++, i++;
    else return false;
    for(; e < t.length && t[e] === "**";)e++;
    return e === t.length && i === r.length;
}
var p = class {
    constructor(s, t){
        var r, e;
        this.value = s, this.subscribers = new Map, this.proxyCache = new WeakMap, this.options = {
            name: (r = t == null ? void 0 : t.name) != null ? r : T,
            updateIfStrictlyEqual: (e = t == null ? void 0 : t.updateIfStrictlyEqual) != null ? e : true
        }, this.debug = false, this.before = (i)=>i, this.setupProxy(), this.count = 1;
    }
    setupProxy() {
        let s = {
            get: (t, r)=>{
                let e = t[r];
                return e && typeof e == "object" ? this.createProxy(e, r.toString()) : e;
            },
            set: (t, r, e)=>{
                let i = e;
                return e && typeof e == "object" && (i = this.createProxy(e, r.toString())), t[r] = i, this.notifySubscribers(r.toString()), true;
            }
        };
        this.value = new Proxy(this.value, s);
    }
    createProxy(s, t) {
        let r = this.proxyCache.get(s);
        if (r) return r;
        let e = {
            get: (u, o)=>{
                let n = u[o];
                return n && typeof n == "object" ? this.createProxy(n, `${t}/${o.toString()}`) : Array.isArray(u) && typeof o == "string" && [
                    "push",
                    "pop",
                    "shift",
                    "unshift",
                    ...
                    let h = n.apply(u, a);
                    return this.notifySubscribers(t), h;
                } : n;
            },
            set: (u, o, n)=>{
                let a = n;
                return n && typeof n == "object" && (a = this.createProxy(n, `${t}/${o.toString()}`)), u[o] = a, this.notifySubscribers(`${t}/${o.toString()}`), true;
            }
        }, i = new Proxy(s, e);
        return this.proxyCache.set(s, i), i;
    }
    notifySubscribers(s) {
        let t = (e, i)=>{
            e.forEach((u)=>{
        ...
        }, r = this.subscribers.get(s);
        if (r) {
            let e = this.getValueAtPath(s);
            t(r, e);
        }
        for (let [e, i] of Array.from(this.subscribers.entries()))if (e !== s) {
            if (e === "**") t(i, this.value);
            else if (v(e, s)) {
                let u = e.split("/"), o;
                if (u.includes("*")) {
                    let n = s.split("/"), a = n.slice(0, -1).join("/"), h = n[n.length - 1];
                    o = this.getValueAtPath(`${a}/${h}`);
                } else if (u.includes("**")) {
                    let n = u.indexOf("**"), a = u.slice(0, n).join("/");
                    o = this.getValueAtPath(a);
                }
                o !== void 0 && t(i, o);
            }
        }
    ...
    subscribe(s, t, r) {
        if (this.subscribers.has(s) || this.subscribers.set(s, new Set), this.subscribers.get(s).add(t), !(r != null && r.skipInitialCall)) {
            let e = s === "**" ? this.value : this.getValueAtPath(s);
            try {
                t(e);
            } catch (i) {}
        }
        return {
            unsubscribe: ()=>{
                let e = this.subscribers.get(s);
                e && (e.delete(t), e.size === 0 && this.subscribers.delete(s));
            }
        };
    }
    getValue() {
    ...
    next(s) {
        if (!(!this.options.updateIfStrictlyEqual && this.value === s)) {
            this.value = this.before(s), this.count++;
            for (let [t, r] of Array.from(this.subscribers.entries())){
                let e = this.getValueAtPath(t);
                e !== void 0 && r.forEach((i)=>{
                    try {
                        i(e);
                    } catch (u) {}
                });
    ...
    unsubscribe(s) {
        for (let [t, r] of Array.from(this.subscribers.entries()))r.delete(s), r.size === 0 && this.subscribers.delete(t);
    }
};
;
 //# sourceMappingURL=index.js.map
...
//# sourceMappingURL=node_modules_58fd518e._.js.map