// Claude wordmark glyph, copied verbatim from the desktop ClaudeLogo
// (components/project/project-detail.tsx) so the /mobile route stays
// self-contained and the Claude badge/button match the desktop exactly.
