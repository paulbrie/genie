...
const VALID_ADMIN_TABS = new Set<AdminTab>(["database", "droplets", "ai", "backup", "users", "teams", "orgs", "communication", "audit", "prodlogs", "analytics", "ssh-events", "connections", "ssh-startups"]);
